...
# SVM Model
The Support Vector Machine (SVM) model is trained using the `svm()` function with a radial basis function (RBF) kernel. The model is evaluated using the confusion matrix.

```{r,message=FALSE, warning=FALSE}
svm_model <- svm(classe ~ ., data = train_data, kernel = "radial", cost = 0.5, gamma = 0.1)
